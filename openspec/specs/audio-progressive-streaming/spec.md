# Audio Progressive Streaming

## Purpose

Enable the backend to stream audio from Telegram progressively without buffering the entire file in memory, and serialize downloads via a priority queue.
