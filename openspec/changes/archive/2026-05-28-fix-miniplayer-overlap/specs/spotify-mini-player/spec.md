...
Additionally, the mini player layout on all secondary detail screens SHALL respect bottom safe area insets (such as system gesture navigation or soft keys) to avoid overlap.
